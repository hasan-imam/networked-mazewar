...
public abstract class Maze {
    ...
    /**
     * Add a {@link Client} to the {@link Maze} at a specific location.
     * Used by addClient(Client client) as a helper.
     * @param client The {@link Client} to be added.
     * @param point The location the {@link Client} should be added.
     * @return Returns true for successful operation. False if the give point is not free for placement
     */
    public abstract boolean addClient(Client client, Point point, Direction dir);
    ...
    /**
     * Obtain an initial {@link Point} for this {@link Client} in the {@link Maze} 
     * @return {@link Point} that is not occupied by anything else. 
     */
