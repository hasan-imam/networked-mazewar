 ...
 * {@link Maze} events and update the score appropriately.
 * @author Geoffrey Washburn &lt;<a href="mailto:geoffw@cis.upenn.edu">geoffw@cis.upenn.edu</a>&gt;
 * @version $Id: ScoreTableModel.java 354 2004-01-26 02:15:32Z geoffw $
 */

public class ScoreTableModel implements TableModel, MazeListener, Serializable{
        ...
        public int getScore (Client client) {
        	ScoreWrapper score = clientMap.get(client);
        	if (score != null) {
        ...
        public boolean setClientScore(Client client, int score) {
        	ScoreWrapper sw = clientMap.get(client);
        	for (Map.Entry<Client, ScoreWrapper> entry : clientMap.entrySet())
        	{
        	    if (entry.getKey().getID() == client.getID()) {
        	    	assert(entry.getKey().getName().equals(client.getName()));
        ...
        public void clientAdded(Client client) {
                ...
                System.out.println("client " + client.getName() + " added in clientMap"); //RM
                notifyListeners();
        } 
        ...
        public void clientFired(Client client) {
                ...
                if (o == null)
                	System.out.println("client doesnt exist in clientMap");
                assert(o instanceof ScoreWrapper);
                scoreSet.remove(o);
                ScoreWrapper s = (ScoreWrapper)o;
